...
from app.auth.tenant import assert_client_access, load_position_for_ctx, require_client_query_access
...
def get_position(
    ...
    obj = load_position_for_ctx(db, position_id, ctx)
    return PositionOut.model_validate(obj)
...
def clone_position(
    ...
    source = load_position_for_ctx(db, position_id, ctx)
