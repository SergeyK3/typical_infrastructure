...
| `SKILL_ASSESSMENT_ARCHIVE_INTEGRITY_SCAN_INTERVAL_SEC` | Интервал фоновой проверки sha256/size/existence для архивов протоколов. `0` — отключить. По умолчанию `3600`. |
