...
| **[docs/guides/руководство_должности_тип_и_ставки.md](../guides/руководство_должности_тип_и_ставки.md)** | HR: одна типовая должность и несколько ставок в отделении; [HTML для скриншота](../guides/руководство_должности_тип_и_ставки.html). |
